...
public class SendMailTLS {
	...
	public static void main(String[] args) {
		...
		try {
			...
			message.setFrom(new InternetAddress("zhangzhuyan53@gmail.com")); //Email to send to
			message.setRecipients(Message.RecipientType.TO,
				InternetAddress.parse("zhangzhuyan53@gmail.com")); // to be added an email addr //Email to send to
